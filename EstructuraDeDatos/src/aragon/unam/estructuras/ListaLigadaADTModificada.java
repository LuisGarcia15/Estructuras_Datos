...
public class ListaLigadaADTModificada<T> implements Iterable<T>{

	private Nodo<T> head;
	private Nodo<T> aux;
	private int tamanio;
	private int tamanioRestringido;

	public ListaLigadaADTModificada() {
		this.head = null;
		this.aux = null;
		this.tamanio = 0;
		this.tamanioRestringido = 5;
	}
	...
	public int getTamanioRestringido() {
		return tamanioRestringido;
	}

	public void setTamanioRestringido(int tamanioRestringido) {
		this.tamanioRestringido = tamanioRestringido;
	}
